...
class Helpers
{
    ...
    |--------------------------------------------------
    */
    public static function erro500(\Throwable $e = null): void
    {
        http_response_code(500);

        // Em desenvolvimento mostra o erro
        if (defined('APP_DEBUG') && APP_DEBUG === true && $e) {
            ...
            // Em produção mostra página amigável
            $diretorio = __DIR__ . '/../../Views/errors/500.twig';
            if (file_exists($diretorio)) {
                $twig = $GLOBALS['twig'];
                self::$twig = new Template($diretorio);
            } else {
    ...
    |--------------------------------------------------
    */
    public static function erroCustomizado(string $mensagem): void
    {
        http_response_code(400);

        if (file_exists(__DIR__ . '/../../views/errors/custom.twig')) {
            $twig = $GLOBALS['twig'];
            echo $twig->render('errors/custom.twig', [
                'mensagem' => $mensagem
            ]);
        } else {
            echo $mensagem;
